...
public class MappEntitiesAbstract {
	 ...
	 * @return
	 */
	protected Banks mapBanks(List<Bank> bankEntities, boolean account, boolean fund) {
	 ...
	 * @return
	 */
	protected Accounts mapAccounts(List<Account> accountList, boolean fund) {
	 ...
	 * @return
	 */
	protected Funds mapFunds(List<Fund> fundList) {
